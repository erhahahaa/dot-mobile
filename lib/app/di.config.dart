...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.lazySingleton<_i998.AthleteClubBloc>(
        () => _i998.AthleteClubBloc(gh<_i561.GetAllClubUsecase>()));
    ...
    gh.lazySingleton<_i481.AthleteExerciseBloc>(
    ...
    gh.lazySingleton<_i810.AthleteTacticalBloc>(
        () => _i810.AthleteTacticalBloc(gh<_i561.GetAllTacticalUsecase>()));
    gh.factory<_i792.UserBloc>(() => _i792.UserBloc(
          gh<_i561.GetMeUsecase>(),
          gh<_i561.FindUsernamesUsecase>(),
          gh<_i561.GetFcmTokenUsecase>(),
        ));
    gh.lazySingleton<_i461.AthleteExamBloc>(
        () => _i461.AthleteExamBloc(gh<_i561.GetAllExamUsecase>()));
    gh.lazySingleton<_i463.AthleteProgramBloc>(
        () => _i463.AthleteProgramBloc(gh<_i561.GetAllProgramUsecase>()));
    return this;
  }
}
