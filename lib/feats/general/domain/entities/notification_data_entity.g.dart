...
extension GetNotificationDataEntityCollection on Isar {
  IsarCollection<NotificationDataEntity> get notificationDataEntitys =>
      this.collection();
}

const NotificationDataEntitySchema = CollectionSchema(
  name: r'NotificationDataEntity',
  id: 837678075593238247,
  properties: {
  ...
  estimateSize: _notificationDataEntityEstimateSize,
  serialize: _notificationDataEntitySerialize,
  deserialize: _notificationDataEntityDeserialize,
  deserializeProp: _notificationDataEntityDeserializeProp,
  idName: r'id',
  indexes: {
    r'uid': IndexSchema(
  ...
  links: {},
  embeddedSchemas: {},
  getId: _notificationDataEntityGetId,
  getLinks: _notificationDataEntityGetLinks,
  attach: _notificationDataEntityAttach,
  version: '3.1.0+1',
);

int _notificationDataEntityEstimateSize(
  NotificationDataEntity object,
  List<int> offsets,
...
void _notificationDataEntitySerialize(
  NotificationDataEntity object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
NotificationDataEntity _notificationDataEntityDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
P _notificationDataEntityDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _notificationDataEntityGetId(NotificationDataEntity object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _notificationDataEntityGetLinks(
    NotificationDataEntity object) {
  return [];
}

void _notificationDataEntityAttach(
    IsarCollection<dynamic> col, Id id, NotificationDataEntity object) {
  object.id = id;
}

extension NotificationDataEntityQueryWhereSort
    on QueryBuilder<NotificationDataEntity, NotificationDataEntity, QWhere> {
  QueryBuilder<NotificationDataEntity, NotificationDataEntity, QAfterWhere>
      anyId() {
...
extension NotificationDataEntityQueryWhere on QueryBuilder<
    NotificationDataEntity, NotificationDataEntity, QWhereClause> {
  ...
  QueryBuilder<NotificationDataEntity, NotificationDataEntity,
      QAfterWhereClause> uidIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NotificationDataEntity, NotificationDataEntity,
      QAfterWhereClause> uidGreaterThan(
    String? uid, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NotificationDataEntity, NotificationDataEntity,
      QAfterWhereClause> uidStartsWith(String UidPrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'uid',
        lower: [UidPrefix],
  ...
  QueryBuilder<NotificationDataEntity, NotificationDataEntity,
      QAfterWhereClause> uidIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension NotificationDataEntityQueryLinks on QueryBuilder<
    NotificationDataEntity, NotificationDataEntity, QFilterCondition> {}
...
extension NotificationDataEntityQueryWhereDistinct
  ...
  QueryBuilder<NotificationDataEntity, NotificationDataEntity, QDistinct>
...
extension NotificationDataEntityQueryProperty on QueryBuilder<
    NotificationDataEntity, NotificationDataEntity, QQueryProperty> {
  QueryBuilder<NotificationDataEntity, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<NotificationDataEntity, String?, QQueryOperations>
      bodyProperty() {
    return QueryBuilder.apply(this, (query) {
