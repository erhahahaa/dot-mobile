...
extension GetProgramEntityCollection on Isar {
  IsarCollection<ProgramEntity> get programEntitys => this.collection();
}

const ProgramEntitySchema = CollectionSchema(
  name: r'ProgramEntity',
  id: -8068497185279465720,
  properties: {
  ...
  estimateSize: _programEntityEstimateSize,
  serialize: _programEntitySerialize,
  deserialize: _programEntityDeserialize,
...
int _programEntityEstimateSize(
  ProgramEntity object,
  List<int> offsets,
...
P _programEntityDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _programEntityGetId(ProgramEntity object) {
  return object.id;
}
...
extension ProgramEntityQueryWhereSort
    on QueryBuilder<ProgramEntity, ProgramEntity, QWhere> {
  QueryBuilder<ProgramEntity, ProgramEntity, QAfterWhere> anyId() {
...
extension ProgramEntityQueryWhere
    on QueryBuilder<ProgramEntity, ProgramEntity, QWhereClause> {
  QueryBuilder<ProgramEntity, ProgramEntity, QAfterWhereClause> idEqualTo(
      Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProgramEntity, ProgramEntity, QAfterWhereClause> idNotEqualTo(
      Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProgramEntity, ProgramEntity, QAfterWhereClause> idGreaterThan(
      Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProgramEntity, ProgramEntity, QAfterWhereClause> idLessThan(
      Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<ProgramEntity, ProgramEntity, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
...
extension ProgramEntityQueryWhereDistinct
  ...
  QueryBuilder<ProgramEntity, ProgramEntity, QDistinct> distinctByClubId() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'clubId');
    });
  }

  QueryBuilder<ProgramEntity, ProgramEntity, QDistinct> distinctByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProgramEntity, ProgramEntity, QDistinct> distinctByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension ProgramEntityQueryProperty
    on QueryBuilder<ProgramEntity, ProgramEntity, QQueryProperty> {
  QueryBuilder<ProgramEntity, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProgramEntity, DateTime?, QQueryOperations> createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProgramEntity, MediaEmbedEntity?, QQueryOperations>
      mediaProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProgramEntity, DateTime?, QQueryOperations> updatedAtProperty() {
    return QueryBuilder.apply(this, (query) {
