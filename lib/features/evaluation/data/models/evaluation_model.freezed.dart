...
mixin _$QuestionEvaluationModel {
  ...
  /// Serializes this QuestionEvaluationModel to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of QuestionEvaluationModel
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
...
/// @nodoc
@JsonSerializable()
class _$QuestionEvaluationModelImpl extends _QuestionEvaluationModel {
  _$QuestionEvaluationModelImpl(
...
abstract class _QuestionEvaluationModel extends QuestionEvaluationModel {
  factory _QuestionEvaluationModel(
      {final int questionId,
      final String? answer,
      final int? score,
      final String? questionName}) = _$QuestionEvaluationModelImpl;
  _QuestionEvaluationModel._() : super._();
