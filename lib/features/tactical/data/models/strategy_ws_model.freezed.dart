...
mixin _$StrategyWSModel {
  ...
  /// Serializes this StrategyWSModel to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of StrategyWSModel
...
mixin _$StrategyWsParamModel {
  ...
  /// Serializes this StrategyWsParamModel to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of StrategyWsParamModel
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
