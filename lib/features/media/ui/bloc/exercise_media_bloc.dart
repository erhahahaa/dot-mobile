...
@lazySingleton
class ExerciseMediaBlocRead extends BlocRead<MediaModel> {
  static const MediaParent parent = MediaParent.exercise;
...
@lazySingleton
class ExerciseMediaBlocWrite extends BlocWrite<MediaModel> {
  static const MediaParent parent = MediaParent.exercise;
