...
class _$MediaEmbedModelImpl extends _MediaEmbedModel {
  ...
  @override
  String toString() {
    return 'MediaEmbedModel(id: $id, creatorId: $creatorId, clubId: $clubId, name: $name, description: $description, fileSize: $fileSize, path: $path, type: $type, parent: $parent, url: $url, thumbPath: $thumbPath, thumbUrl: $thumbUrl, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
